...
LightMapDemoScene.prototype.Load = function (cb) {
	...
	async.parallel({
		Models: function (callback) {
			async.map({
				RoomModel: './scene_illumination/Room.json'
			}, loadJSONResource, callback);
		},
		ShaderCode: function (callback) {
			async.map({
				'NoShadow_VSText': './scene_illumination/shaders/NoShadow_vs.glsl',
				'NoShadow_FSText': './scene_illumination/shaders/NoShadow_fs.glsl',
				'Shadow_VSText': './scene_illumination/shaders/Shadow_vs.glsl',
				'Shadow_FSText': './scene_illumination/shaders/Shadow_fs.glsl',
				'ShadowMapGen_VSText': './scene_illumination/shaders/ShadowMapGen_vs.glsl',
				'ShadowMapGen_FSText': './scene_illumination/shaders/ShadowMapGen_fs.glsl'
